...
def insert_data():
    author=Author.objects.create(
        name='布一小小',
        password='123',
        introduction='希望书友们相互转告，帮忙广告，你们的支持就是我的力量！求点击、求推荐、求书评，各种求！',
        avator='http://img1.chuangshi.qq.com/account/p1/head_photo/default-avatar.png',
        IDcard='aaa',
        truename='aaa',
    )
    book=Book.objects.create(
        name='美人心慈',
        introduction='''佛系少女，安清颜，救了一直橘猫后，穿越古代到嚣张跋扈的公主楚泷千身上。
楚泷千姿色倾城，但原本嚣张跋扈，学识浅薄，臭名远扬。
虽生就一副好皮囊，但并不招人待见。
皇帝也拿他没办法迟到，我日西琉国的皇子忽然提出联姻之请，点名了要娶她……''',
        author=author,
        classification='4',
        image='http://wfqqreader-1252317822.image.myqcloud.com/cover/646/25078646/t5_25078646.jpg',
        click_volume='301',
        like_volume='301',
        word_count='26498',
        collection_amount='60',
    )
...
　　斤。张飞造丈八点钢矛。各置全身铠甲。共聚乡勇五百余人，来见邹靖。邹靖引见太守刘焉。三人参见毕，各通姓名。玄德说起宗派，刘焉大喜，遂认玄德为侄。不数日，人报黄巾贼将程远志统兵五万来犯涿郡。刘焉令邹靖引玄德等三人，统兵五百，前去破敌。玄德等欣然领军前进，直至大兴山下，与贼相见。贼众皆披发，以黄巾抹额。当下两军相对，玄德出马，左有云长，右有翼德，扬鞭大骂：“反国逆贼，何不早降！”程远志大怒，遣副将邓茂出战。张飞挺丈八蛇矛直出，手起处，刺中邓茂心窝，翻身落马。程远志见折了邓茂，拍马舞刀，直取张飞。云长舞动大刀，纵马飞迎。程远志见了，早吃一惊，措手不及，被云长刀起处，挥为两段。后人有诗赞二人曰：英雄露颖在今朝，一试矛兮一试刀。初出便将威力展，三分好把姓名标。
　　
　　众贼见程远志被斩，皆倒戈而走。玄德挥军追赶，投降者不计其数，大胜而回。刘焉亲自迎接，赏劳军士。次日，接得青州太守龚景牒文，言黄巾贼围城将陷，乞赐救援。刘焉与玄德商议。玄德曰：“备愿往救之。”刘焉令邹靖将兵五千，同玄德、关、张，投青州来。
...
　　三人救了董卓回寨。卓问三人现居何职。玄德曰：“白身。”卓甚轻之，不为礼。玄德出，张飞大怒曰：“我等亲赴血战，救了这厮，他却如此无礼。若不杀之，难消我气！”便要提刀入帐来杀董卓。正是：人情势利古犹今，谁识英雄是白身？安得快人如翼德，尽诛世上负心人！毕竟董卓性命如何，且听下文分解。''',
    ...
    chapter2 = Chapter.objects.create(
        name='第2章 梦中魂穿',
        book=book,
        content='''且说董卓字仲颖，陇西临洮人也，官拜河东太守，自来骄傲。当日怠慢了玄德，张飞性发，便欲杀之。玄德与关公急止之曰：“他是朝廷命官，岂可擅杀？”飞曰：“若不杀这厮，反要在他部下听令，其实不甘！二兄要便住在此，我自投别处去也！”玄德曰：“我三
...
　　
　　一日，帝在后园与十常侍饮宴，谏议大夫刘陶，径到帝前大恸。帝问其故。陶曰：“天下危在旦夕，陛下尚自与阉宦共饮耶！”帝曰：“国家承平，有何危急？”陶曰：“四方盗贼并起，侵掠州郡。其祸皆由十常侍卖官害民，欺君罔上。朝廷正人皆去，祸在目前矣！”
...
　　六月，何进暗使人鸩杀董后于河间驿庭，举柩回京，葬于文陵。进托病不出。司隶校尉袁绍入见进曰：“张让、段珪等流言于外，言公鸩杀董后，欲谋大事。乘此时不诛阉宦，后必为大祸。昔窦武欲诛内竖，机谋不密，反受其殃。今公兄弟部曲将吏，皆英俊之士；若使尽力，事在掌握。此天赞之时，不可失也。”进曰：“且容商议。”左右密报张让，让等转告何苗，又多送贿赂。苗入奏何后云：“大将军辅佐新君，不行仁慈，专务杀伐。今无端又欲杀十常侍，此取乱之道也。”后纳其言。少顷，何进入白后，欲诛中涓。何后曰：“中官统领禁省，汉家故事。先帝新弃天下，尔欲诛杀旧臣，非重宗庙也。”进本是没决断之人，听太后言，唯唯而出。袁绍迎问曰：“大事若何？”进曰：“太后不允，如之奈何？”绍曰：“可召四方英雄之士，勒兵来京，尽诛阉竖。此时事急，不容太后不从。”进曰：“此计大妙！”便发檄至各镇，召赴京师。主薄陈琳曰：“不可！俗云：掩目而捕燕雀，是自欺也，微物尚不可欺以得志，况国家大事乎？今将军仗皇威，掌兵要，龙骧虎步，高下在心：若欲诛宦官，如鼓洪炉燎毛发耳。但当速发雷霆，行权立断，则天人顺之。却反外檄大臣，临犯京阙，英雄聚会，各怀一心：所谓倒持干戈，授人以柄，功必不成，反生乱矣。”何进笑曰：“此懦夫之见也！”傍边一人鼓掌大笑曰：“此事易如反掌，何必多议！”视之，乃曹操也。正是：欲除君侧宵人乱，须听朝中智士谋。不知曹操说出甚话来，且听下文分解。''',
    ...
    chapter3 = Chapter.objects.create(
        name='第3章 带回尚府',
        book=book,
        content='''且说曹操当日对何进曰：“宦官之祸，古今皆有；但世主不当假之权宠，使至于此。若欲治罪，当除元恶，但付一狱吏足矣，何必纷纷召外兵乎？欲尽诛之，事必宣露。吾料其必败也。”何进怒曰：“孟德亦怀私意耶？”操退曰：“乱天下者，必进也。”进乃暗差使命，赍密诏星夜往各镇去。
　　
...
def getBooks(request):
    if request.method == 'GET':
        ...
        res['code'] = 200
        data = {}
        recommend = get_recomend()
        rankList = get_rankList()
        newArrival = get_newArrival()
        clickList = get_clickList()
        classification5120 = get_classification5120()
        classification24576 = get_classification24576()
        classification33280 = get_classification33280()
        data['recommend'] = recommend
        data['rankList'] = rankList
        data['newArrival'] = newArrival
        data['clickList'] = clickList
        data['guyanxuanyi'] = classification5120
        data['xianyanqingchun'] = classification24576
        data['huanqingkehuan'] = classification33280
        res['data'] = data
...
def getBook(request):
    if request.method == 'GET':
        ...
        print(bid)
        try:
            target = Book.objects.get(id=bid)
        except:
            return JsonResponse({'code': 404, 'error': 'not found this book'})
        data = {}
        data['bid'] = target.id
        data['bookName'] = target.name
        data['imageUrl'] = str(target.image)
        data['click_volume'] = target.click_volume
        data['introduction'] = target.introduction
        data['authorId'] = target.author.id
        data['authorName'] = target.author.name
        try:
            lastChapter = Chapter.objects.filter(book=target).last()
...
def get_recomend():
    sql = 'select id from book order by collection_amount desc limit 15'
    list_book = Book.objects.raw(sql)
    recommend = []
    for book in list_book:
        ...
        data['click_volume'] = book.click_volume
...
def get_rankList():
    sql = 'select id,name from book order by like_volume desc limit 8'
    infos = ('id', 'name')
    # books = do_query(sql)
    # return make_res(books, infos)
    return select_books(sql, infos)


def get_newArrival():
    sql = 'select id,name,author_id,classification from book order by id desc limit 6'
    infos = ('id', 'name', 'authorId', 'authorName', 'classification')
    # books = do_query(sql)
    # return make_res(books, infos)
    return select_books(sql, infos)
...
def get_clickList():
    sql = 'select id,name,classification from book order by click_volume desc limit 5'
    infos = ('id', 'name', 'classification')
    # books = do_query(sql)
    # return make_res(books, infos)
    return select_books(sql, infos)


def get_classification5120():
    sql = 'select id,name,introduction,image from book where classification=5120 order by like_volume desc limit 15'
    infos = ('id', 'name', 'introduction', 'imageUrl')
    # books = do_query(sql)
    # res = {}
    # res['main'] = make_res(books[:3], infos)
    # infos2 = ('id', 'name')
    # res['other'] = make_res(books[3:], infos2)
    # return res
    return select_books(sql, infos)


def get_classification24576():
    sql = 'select id,name,introduction,image from book where classification=24576 order by like_volume desc limit 15'
    infos = ('id', 'name', 'introduction', 'imageUrl')
    # books = do_query(sql)
    # res = {}
    # res['main'] = make_res(books[:3], infos)
...
def get_classification33280():
    sql = 'select id,name,introduction,image from book where classification=33280 order by like_volume desc limit 15'
    infos = ('id', 'name', 'introduction', 'imageUrl')
    # books = do_query(sql)
    # res = {}
    # res['main'] = make_res(books[:3], infos)
...
def select_books(sql,infos):
    res=[]
    books = Book.objects.raw(sql)
    for book in books:
        book_ = {}
        for i in range(len(infos)):
            if infos[i] == 'authorName':
                book_[infos[i]] = book.author.name
            elif infos[i] == 'authorId':
                book_[infos[i]] = book.author.id
            elif infos[i] == 'imageUrl':
                book_[infos[i]] = str(book.image)
            elif infos[i] == 'classification':
                book_[infos[i]] = parse_classification(getattr(book, infos[i]))
            else:
                book_[infos[i]] = getattr(book, infos[i])
        res.append(book_)
    return res
def do_query(sql):
    try:
